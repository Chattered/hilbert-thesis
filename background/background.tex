...
This approach does not have the drawback of Harrison's solution. Whenever the case splitting is not exhaustive, the \code{end} step will fail at the point at which it is evaluated, rather than at the very end of the verification when the final justification is assembled.
