...
\newcommand{\forms}[1]{#1_1,#1_2,\ldots,#1_n}
\newcommand{\cforms}[1]{#1_1\wedge#1_2\wedge\cdots\wedge#1_n}
...
\include{introduction/foundations}

\include{systems/systems}

\include{group1/group1}

\include{automation/automation}

\include{group2/group2}
