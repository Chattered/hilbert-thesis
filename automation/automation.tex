...
\begin{figure}
\centering\includegraphics[scale=0.28]{automation/DataFlow}
...
An \emph{idiom} or \emph{applicative functor} $F$~\cite{Applicative} is a generalisation of the monad, which could be thought of as providing at least the ability to lift values with a function $pure\;:\;\alpha \rightarrow F\ \alpha$ and to lift a two argument function as we do with 
\begin{displaymath}
