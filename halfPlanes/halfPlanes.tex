...
We are unclear why these definitions are emphasised. \emph{Rays} appear to be an important notion for later definitions and axioms, but a potential and unweildy four-place relation $\code{same\_side}$
