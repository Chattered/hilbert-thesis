...
%The purpose of formal verification is to eliminate the need for peer review in mathematics and programming, and instead create a world where one only needs to exchange arguments with machine. Thankfully, we have not yet reached this uptopia, and thus, I get to thank the following human beings: 

% My supervisor, Jacques Fleuriot, for helping me maintain perspective and for his excellent writing tips; my supervisors, Jacques and Alan Smaill, for reading through drafts of my thesis, complete with annoying typos; Grant Passmore for his general enthusiasm; and Steven Obua for helping me with a proof at the final hurdles.
