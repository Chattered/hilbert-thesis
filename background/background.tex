...
\begin{figure}
  \begin{gather*}
    \begin{aligned}
      ...
      \text{for $x$ not free in $\Gamma$,}\quad\infer[\code{ABS}]{\Gamma \vdash (\lambda x.\; s) = \lambda x.\; t}{\Gamma \vdash s = t}\\
...
Case-splits are ultimately justified by proving a disjunction of all considered cases. However, in Mizar-style verifications and as is common in ordinary mathematical proofs, the particular disjunction is never stated explicitly. Consider again the extract of Mizar Light code:
