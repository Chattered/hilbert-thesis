...
\begin{figure}
\centering
\includegraphics[scale=0.2]{jordan/densemaze.pdf}
...
We were initially satisfied by Veblen's proof, and so we attempted to verify it. Eventually, as one might expect, we hit an obstacle, and had to give up. In the next few sections, we will suggest where Veblen's proof goes wrong.
