...
\begin{gather*}
  \begin{split}
    ...
    &\qquad\iff P \neq O\\
    &\qquad\qquad\quad\wedge \code{equiv\_arrow}\ \overrightarrow{OQ}\ (\code{mk\_arrow}\ (Q, P)).
  \end{split}
\end{gather*}
...
This omission is barely a chink compared to the chasm which follows. Hilbert gives no indication how to prove THEOREM~9. A discussion of this theorem and its verification take up the next four chapters.
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: "../thesis"
%%% End: 
